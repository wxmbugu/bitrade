  ...
  <div class="cexchange">
                    ...
                    <div class="trade_bd_ctc">
                      <div class="panel panel_buy">
                        <div class="bd bd_limited">
                          ...
                          <Form style="width: 100%; " class="mobile-form">
                            ...
                            <FormItem class="trade-input hide-on-mobile">
                              ...
                              <RadioGroup v-model="baseCoinUnit" class="group-radio">
                                  ...
                                  <div><Radio label="BTC" style="margin-bottom:10px;">
                                    ...
                                    <Input style="width:250px;" disabled :placeholder="$t('cexchange.assets') + assetBtc"></Input>
                                  ...
                                  <div><Radio label="ETH">
                                    ...
                                    <Input style="width:250px;" disabled :placeholder="$t('cexchange.assets') + assetEth"></Input>
                            ...
                            <FormItem class="trade-input show-on-mobile" >
                              <label class="before" style="width:180px;text-align:right;">{{$t('cexchange.choosecurrency')}}：</label>
                              <RadioGroup v-model="baseCoinUnit" class="group-radio">
                                  <div>
                                   
                                    <div >
                                    <Radio label="USDT" style="margin-bottom:10px;" />
                                    <!-- <span style="width:40px;display: inline-block;font-size: 14px;">USDT</span> -->
                                    <Input style="width:70%;" disabled :placeholder="$t('cexchange.assets') + assetUsdt"></Input>
                                    </div>
                                    <div style="margin-top:10px;">
                                    <Button style="width:40%;margin-left:10px;" type="primary" @click="allBy(0)" size="small">{{$t('cexchange.all')}}</Button>
                                    <span style="margin-left: 20px;">1 USDT ≈ {{usdtRate}} BZB</span>
                                    </div>
                                  <br/></div>
                                  <div>
                                    <div>
                                    <Radio label="BTC" style="margin-bottom:10px;" />
                                    <!-- <span style="width:40px;display: inline-block;font-size: 14px;">BTC</span> -->
                                    <Input style="width:70%;" disabled :placeholder="$t('cexchange.assets') + assetBtc"></Input>
                                    </div>
                                    <div style="margin-top:10px;">
                                    <Button style="width:40%;margin-left:10px;" type="primary" @click="allBy(1)" size="small">{{$t('cexchange.all')}}</Button>
                                    <span style="margin-left: 20px;">1 BTC ≈ {{btcRate}} BZB</span>
                                  ...
                                  <div>
                                    ...
                                    <Radio label="ETH" />
                                    <!-- <span style="width:40px;display: inline-block;font-size: 14px;">ETH</span> -->
                                    <Input style="width:70%;" disabled :placeholder="$t('cexchange.assets') + assetEth"></Input>
                                    </div>
                                    <div style="margin-top:10px;">
                                   
                                    <Button style="width: 40%;margin-left:10px;" type="primary" @click="allBy(2)" size="small">{{$t('cexchange.all')}}</Button>
                                    <span style="margin-left: 20px;">1 ETH ≈ {{ethRate}} BZB</span>
                                    </div>
                                  <br/></div>
                              </RadioGroup>
                            ...
                            <FormItem>
                              <label class="before" style="width:180px;text-align:left;">{{$t('cexchange.totalpay')}}：</label>
                              <p style="text-align:center;margin-left:0px;margin-right:0px;font-size:26px;font-weight: bold;color:#ffec03;">{{totalPaymentShow | fixed8}}</p>
                            </FormItem>
                            <FormItem style="margin-top: 10px;">
                              <label class="before"></label>
                              <Button v-if="isLogin" style="margin-left:0px;width:40%;" size="large" type="primary" @click="confirm()">{{$t('cexchange.confirmpay')}}</Button>

                              <Button v-else style="margin-left:0px;width:40%;" size="large" type="default">{{$t('cexchange.loginFirst')}}</Button>
                            </FormItem>
                          </Form>
                        </div>
                      </div>
    ...
    <Modal v-model="modal" width="450">
      ...
      <div slot="footer">
        ...
        <span style="background:#ffec03;color:#fff;width:80px;border-radius:30px;display:inline-block;text-align:center;height:30px;line-height: 30px;" @click="submit()">{{$t("cexchange.ok")}}</span>
      </div>
    </Modal>
  </div>
</template>
...
.quantity-group .quantity-item{
  float: none !important;
  margin-left: 0px !important;
  margin-top: 10px !important;
}
.group-radio{
  text-align:left;margin-left:0px !important;float:none !important;
}
...
.group-radio{
  text-align:left;margin-left:215px;float:left;
}
.black-panel{
  min-height: 65px;
  width:100%;
...
.ctc-order-status{
  text-align:center;margin-bottom: 15px;background: #ffec03;padding: 5px 0px;border-radius: 2px;color: #000000;
}
