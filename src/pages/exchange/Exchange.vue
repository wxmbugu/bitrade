<template>
 <div>
  <div v-if="!isMobile()" class="container exchange" :class="skin">
     <div class="main">
      <div class="right">
        <div class="coin-menu">
      ...
      <div class="center">
        <div class="symbol">
          <div class="item" @click="currentCoinFavorChange">
            <Icon v-if="currentCoinIsFavor" type="ios-star" color="#ffec03" size="24" />
            <Icon v-else type="ios-star-outline" color="#ffec03" size="24" />
          </div>
            ...
            <div class="mask" v-show="!isLogin">
              <span>{{$t("common.please")}}
                <router-link to="/login">
                  <span style="color:#ffec03;">{{$t("common.login")}}</span>
                </router-link> /
...
-->
       ...
       <div class="center">
         <div class="symbol-mobile">
          
          <div class="item" style="padding-top:5px;padding-bottom:15px;" >
            <div class="item" @click="currentCoinFavorChange">
            <Icon v-if="currentCoinIsFavor" type="ios-star" color="#ffec03" size="24" />
            <Icon v-else type="ios-star-outline" color="#ffec03" size="24" />
          </div>
              <span style="margin-left:10px;" class="coin">{{currentCoin.coin}}
                <small>/{{currentCoin.base}}</small>
              </span>
            <Poptip trigger="hover" :title="coinInfo.name" content="content"  placement="bottom-start" word-wrap width="300">
              <Icon type="md-information-circle" style="color:#546886;margin-left:5px;"/>
          ...
          <div class="trade_panel trade_panel_logout">
            ...
            <div class="trade_bd" >
              <div style="display:block;">
                <div class="panel-mobile panel_buy">
                <div v-if="isLogin" class="hd hd_login">
                  <span>{{currentCoin.base}}</span>
                  <span>{{wallet.base|toFloor(baseCoinScale)}}</span>
                  <span>{{$t("exchange.canuse")}}</span>
              ...
              <div class="panel-mobile panel_sell">
                <div v-if="isLogin" class="hd hd_login">
                  <span>{{$t("exchange.canuse")}}</span>
                  <span>{{wallet.coin|toFloor(coinScale)}}</span>
                  <span>{{currentCoin.coin}}</span>
