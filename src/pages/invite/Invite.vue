  ...
  <div class="invite">
    <div class="header">
      ...
      <div class="invite-title ">
       ...
       <div class="invite-title "  > <!-- show on mobile view -->
      ...
      <div class="invite-detail">
        <div class="item">
          ...
          <p class="i-t">{{$t('invite.mylevel1ratio')}}</p>
        </div>
        <div class="item">
          <p class="i-v">{{myInfo.leveltwo}}</p>
          <p class="i-t">{{$t('invite.mylevel2ratio')}}</p>
        </div>
        <div class="item">
      ...
      <div class="mask" v-if="!isLogin">
        <div class="login-btn">
              <ButtonGroup size="large" class="display-flex">
                   <div style="margin-right:20px;">
                       <Button type="primary" style="color:#5c5b59 !important; " to="/login">{{$t("common.login")}}</Button>

                   </div>
                   <div style="margin-right:20px;">
                                       <Button type="primary" style="color:#5c5b59 !important;" to="/register">{{$t("common.register")}}</Button>
      ...
      <div class="invite-content">
        ...
        <div class="content">
          ...
          <table class="percent-table">
            ...
            <td>{{$t('invite.level')}}</td><td>{{$t('invite.mylevel1')}}</td><td>{{$t('invite.mylevel1ratio')}}</td>
            <td>{{$t('invite.mylevel2ratio')}}</td><td>{{$t('invite.mylevel3ratio')}}</td><td>{{$t('invite.mylevel4ratio')}}</td>
            <td>{{$t('invite.mylevel5ratio')}}</td><td>{{$t('invite.mylevel6ratio')}}</td><td>{{$t('invite.mylevel7ratio')}}</td>
            <td>{{$t('invite.mylevel8ratio')}}</td>
            <!-- <td>{{$t('invite.levelonecount')}}</td><td>{{$t('invite.levelonecommission')}}</td>
            <td>{{$t('invite.leveltwocommission')}}</td><td>{{$t('invite.partnerdivide')}}</td> -->
            </tr>

            <tr><td>L1({{$t('invite.lv1')}})</td><td>0 ≤ N ≤ 10</td><td>8%</td><td>6%</td><td>4%</td><td>3%</td> <td>2%</td><td>2%</td><td>2%</td> <td>1%</td></tr>
            <tr><td>L2({{$t('invite.lv2')}})</td><td>10 < N ≤ 100</td><td>8%</td><td>6%</td><td>4%</td> <td>3%</td>  <td>2%</td><td>2%</td><td>2%</td><td>1%</td></tr>
            <tr><td>L3({{$t('invite.lv3')}})</td><td>100 < N ≤ 500</td><td>8%</td><td>6%</td><td>4%</td> <td>3%</td>  <td>2%</td><td>2%</td><td>2%</td><td>1%</td></tr>
            <tr><td>L4({{$t('invite.lv4')}})</td><td>500 < N ≤ 1500</td><td>8%</td><td>6%</td><td>4%</td> <td>3%</td>  <td>2%</td><td>2%</td><td>2%</td><td>1%</td></tr>
            <tr><td>L5({{$t('invite.lv5')}})</td><td>1500 < N ≤ 3000</td><td>8%</td><td>6%</td><td>4%</td> <td>3%</td>  <td>2%</td><td>2%</td><td>2%</td><td>1%</td></tr>
            <tr><td>L6({{$t('invite.lv6')}})</td><td>3000 < N</td><td>8%</td><td>6%</td><td>4%</td> <td>3%</td> <td>2%</td><td>2%</td><td>2%</td> <td>1%</td></tr>
          </table>
          </div>
          <div style="margin-top:10px;font-size: 12px;padding:10px;margin-left:0px;width: 100%;margin-bottom: 10px;border: 1px solid #c8c8c8;">
            ...
            <p style="text-indent: 25px;overflow-x:auto;">    {{$t('invite.ruleexamplecontent2')}}</p>
          </div>
      ...
      <div class="promotion-tools">
        ...
        <div class="tools">
          <div class="item" @click="showCardItem">
              <img src="https://bizzan6.oss-accelerate.aliyuncs.com/2019/08/08/promotioncard.png"></img>
          ...
          <div class="item" @click="useInviteImage">
              <img src="https://bizzan6.oss-accelerate.aliyuncs.com/2019/08/08/invitebg.jpg"></img>
    ...
    <Drawer :title="$t('invite.pt_title')" :closable="false" v-model="showCardModal" width="600">
      <div class="ptcard-header">
        <img class="card-img" src="https://bizzan6.oss-accelerate.aliyuncs.com/2019/08/08/promotioncard.png"></img>
        <div class="desc">
      ...
      <div class="ptcard-info">
        ...
        <p class="detail">{{$t('invite.pt_card_rule1')}}：promotion@bizzan.vip。</p>
  ...
  data() {
    ...
    return {
      ...
      myInfo: {
        ...
        extrareward: 0,
        partnerlevel: "-",
        inviteLink: "https://btearn.com/#/reg?code=OQT8"
      },
      promotionRecordPage: {
        pageNo: 1,
        pageSize: 10
 ...
 @media only screen and (max-width: 768px) {
   ...
   .invite{
     ...
     .main{
       ...
       .promotion-tools .tools .item{
         margin-top: 10px !important;
       }
       .promotion-tools .tools .item p.title{
         text-align: center !important;
       }
       .promotion-tools .tools .item p.desc{
         text-align: center !important;
       }
