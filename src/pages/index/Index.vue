     ...
     <div id="pagetips" style="border-bottom:1px solid rgb(28, 39, 58);">
        ...
        <div class="agent-panel">
          ...
          <div class="agent-list">
            <div class="agent-item">
              ...
              <router-link to="/helpdetail?cate=0&id=15&cateTitle=Beginner%27s%20Guide" target="_blank">
            ...
            <div class="agent-item">
              ...
              <router-link to="/helpdetail?cate=0&id=16&cateTitle=Beginner%27s%20Guide" target="_blank">
                <div class="agent-detail">
            ...
            <div class="agent-item">
              ...
              <router-link to="/helpdetail?cate=0&id=17&cateTitle=Beginner%27s%20Guide" target="_blank">
                <div class="agent-detail">
            ...
            <div class="agent-item">
              ...
              <router-link to="/helpdetail?cate=0&id=18&cateTitle=Beginner%27s%20Guide" target="_blank">
                <div class="agent-detail">
      ...
      <div style="width: 100%;background: #141e2c;display:none;">
        <router-link to="/announcement/118930" target="_blank" style="width: 100%;">
          <img src="https://bizzan6.oss-accelerate.aliyuncs.com/bannerimg.png" style="width: 72%;margin-left: 14%;margin-top: 20px;">
        </router-link>
      </div>
  ...
  <div v-if="isMobile()">
    <div id="fullpage">
     <!-- <div id="pagetips" style="border-bottom:1px solid rgb(28, 39, 58);">
      ...
      <div class="section" id="page1">
        <!-- <div v-if="lang==='简体中文'"> -->
        <div class="spin-wrap banner-panel-mobile">
          <img style="height: 100%;" src="../../assets/images/bannerbg.png" />
          <p style="margin-right:auto;margint-left:auto;text-align:center;font-size:20px;font-weight:bold;color:#fff;position:absolute;top: 90px;width:95%;letter-spacing:5px;text-shadow: 0px 0px 10px #000000;">{{$t("common.slogan")}}</p>
          <p style="text-align:center;font-size:15px;color:#828ea1;position:absolute;top: 180px;width:100%;letter-spacing:2px;">{{$t("common.subslogan")}}</p>
          <div class="activity-list" v-show="picShow">
            <div class="swiper-container" id="swiper_container">
              <div class="swiper-wrapper">
                <div class="swiper-slide" v-for="(item,index) in picList">
      ...
      <div class="section" style="padding: 0px 5%;padding-top:50px;padding-bottom:10px;background: #141e2c;">
        <div ref="trendPanel" style="width:100%;border-top:1px solid #1e2834;border-left:1px solid #1e2834;border-right:1px solid #1e2834;text-align: center;padding: 150px 0 0 0;position: relative;">
          <div style="position: absolute;top: 20px;left:20px;right:20px;font-size: 20px;font-weight: bold;color:#828ea1;">BTC/USDT Trend</div>
          <SvgIndex ref="svgIndexRef" style="margin-bottom: -5px;" :width="800" :height="150" :values="lineValues"></SvgIndex>
          <div style="position:absolute;top:50px;left:20px;right:20px;color:#828ea1;"><span class="lastest-price" style="font-size:40px;font-weight: normal;">{{trendData.close | fixed2}}</span><span style="font-weight: bold;">/USDT</span></div>
      ...
      <div class="section" id="page2-mobile">
        <div class="page2nav">
          <div class="board-title" style="display:inline-block;display: none;">{{$t('sectionPage.mainboard')}}  &nbsp; >>></div>
          <ul class="brclearfix">
            <li v-show="!(index==0&&!isLogin)" v-for="(item,index) in indexBtn" @click="addClass(index)" :class="{'active':index==choseBtn,'ivu-btn-default':index!=choseBtn}" :key="index">{{item.text}}</li>
...
-->
      ...
      <div class="section" id="page4-mobile">
        <ul>
          <li>
            <div><img src="../../assets/images/feature_safe.png" alt=""></div>
            <p class="title">{{$t('description.title1')}}</p>
      ...
      <div class="section" id="page5-mobile" style="display:block">
        <div class="phone_image"></div>
        <div>
          <ul class="download">
          <li class="qrcode">{{$t('description.scanqrcode')}}</li>
...
.banner-panel-mobile{
  height:270px;background-color:#141e2b;overflow:hidden;position:relative;
  display: flex;
  justify-content: center;
  .activity-list{
    width: 100%;min-width:1200px;display:flex;flex-start:row;justify-content:center;position:absolute;bottom: 20px;
...
#pagetips{
  .agent-panel{
    ...
    .agent-all{
      height:62px;text-align:right;line-height:62px;background:transparent;position:absolute;right:12px;font-size:12px;color: #ffec03;
    }
  }
  .agent-panel-mobile{
  position:relative;
  ...
  .page2nav {
    ...
    .brclearfix {
      ...
      li.active {
        ...
        color: #ffec03;
        position: relative;
        border-bottom: 2px solid #ffec03;
      }
    }
  }
  .ptjy {
