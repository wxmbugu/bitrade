  ...
  <div class="content_container">
    <div class="wrapper">
      <div class="content_wrapper">
        <div class="content1">
          <h5>BZB介绍</h5>
          <p>BZB是币严(WWW.BIZZAN.VIP)交易平台权益凭证，总发行量5亿枚，永不增发。BZB的持有者除了可享受代币升值、收益分红、上币分红等权益外，还可以通过参与币严(WWW.BIZZAN.VIP)超级节点(合伙人)投票获得节点收益，超级节点具有决策参与权、第一知情权、优先上币权以及未来上市股票分配等传统企业股东权益。
</p>
      ...
      <div class="content_wrapper">
        <div class="content1">
          <h5>白皮书</h5>
          <p>币严(WWW.BIZZAN.VIP)数字资产交易平台白皮书-中文版.pdf</p>
