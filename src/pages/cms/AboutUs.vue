...
@media only screen and (max-width:1024px){
  .wrapper_logo ul {
      ...
      li {
        ...
        border-right: 0px solid #27313e !important;
        
      }
  }
  .about_us_container .wrapper .wrapper_logo ul{
    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          ...
          <p>{{$t('description.support')}}：realbitearn@gmail.com</p>
