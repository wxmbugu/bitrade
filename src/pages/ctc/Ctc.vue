      ...
      <div class="main">
          <Tabs :animated="false" style="width:100%;">
            <TabPane :label="'USDT' + $t('ctc.trade')" name="all">
                        ...
                        <div class="bd bd_limited">
                          <Form>
                            ...
                            <FormItem class="trade-input">
                              ...
                              <InputNumber style="width:60%;float:right;" v-model="buyAmount"  size="large" :max="50000" :min="50" :placeholder="$t('ctc.input50tips')"></InputNumber>
                            ...
                            <FormItem>
                              ...
                              <Select v-model="payType" style="width:60%;float:right;height:40px;" size="large" :placeholder="$t('common.pleaseselect')">
                            ...
                            <div class="total buy_total" style="min-height">
                              ...
                              <div style="width: 100%;font-size:12px;text-align:left;">{{$t("ctc.moneyTips")}}</div>
                            </div>
                        ...
                        <div class="bd bd_limited">
                          <Form ref="formValidate">
                            ...
                            <FormItem class="trade-input">
                              ...
                              <InputNumber style="width:60%;float:right;" v-model="sellAmount" size="large" :max="50000" :min="50" :placeholder="$t('ctc.input50tips')"></InputNumber>
                              <label class="after">USDT</label>
                            </FormItem>
                            ...
                            <FormItem>
                              ...
                              <Select v-model="receiveType" style="width:60%;float:right;height:40px;" size="large" :placeholder="$t('common.pleaseselect')">
                                  <Option v-for="item in receiveTypeList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                              </Select>
                            </FormItem>
                            <div style="min-height: 30px;line-height: 30px;margin-top: -20px;text-align:left;margin-bottom: 5px;font-size: 12px;">
              ...
              <div class="table">
                <Table class="ctc_tbl" :no-data-text="$t('common.nodata')" :columns="columns" :data="orders" :loading="loading"></Table>
                <div class="page">
...
<style lang="scss" scoped>
  .notice-panel{
    float:right;width: 30%;height: 455px;font-size: 12px;color: #bcbcbc;
  }
  .ctc {
    height: 100%;
