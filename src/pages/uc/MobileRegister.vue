<template>
  <div class="login_form mob-login">
    <div class="login_right">
      <div style="color: #ffec03;margin-bottom: 60px;margin-top: 60px;">
        <h1 style="border-left: 5px solid #ffec03;padding-left: 10px;letter-spacing: 2px;line-height:30px;height:30px;">btearn.com</h1>
        <p style="padding-left:15px;letter-spacing: 6px;">{{$t('footer.gsmc')}}</p>
        <div style="margin-left:5px;letter-spacing: 2px;margin-top: 10px;color: rgb(226, 226, 227);font-size:13px;padding: 5px 10px;">Safety ● honesty ● fairness ● enthusiasm ● openness</div>
      </div>
        ...
        <FormItem prop="user">
          <Input type="text" v-model="formInline.user" :placeholder="key">
            <Select v-model="country" slot="prepend" style="width: 65px;border-bottom: 1px solid #27313e;">
			 <!-- <Option value="美国" label="+1"><span>+1</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.American')}}</span></Option>
	      ...
	      <Option value="新加坡" label="+65"><span>+65</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.singapore')}}</span></Option>
              ...
              <Option value="法国" label="+33"><span>+33</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.france')}}</span></Option>
              <Option value="西班牙" label="+34"><span>+34</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.spain')}}</span></Option>
              <Option value="巴基斯坦" label="+92"><span>+92</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.pakistan')}}</span></Option>
            </Select>
          </Input>
        </FormItem>
