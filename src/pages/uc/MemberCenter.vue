<style lang="scss" scoped>
  ...
  <template>
    <div class="mymsg_wrapper">
        ...
        <Row :gutter="20" style="min-height: 600px;padding-top: 10px;">
          <Col :xs="24" :sm="24" :md="5" :lg="5">
            ...
            <Menu class="pc_menu" :active-name="activename" :open-names="opennames" @on-open-change="sss" ref="test" :accordion="true" style="width:100%;">
              ...
              <MenuItem name="2-10">
                <router-link class="content" to="/uc/swapAssets">Assets</router-link>
              </MenuItem>
              <!-- <Submenu name="2">
                <template slot="title">
                  <span class="isclick"></span>
              ...
              <MenuItem name="7-1">
                  <router-link class="content" to="/uc/apiManage">{{$t("uc.api.apiAdmin")}}</router-link>
              </MenuItem>
              <!-- <Submenu name="7">
                  <template slot="title">
                      <span class="isclick"></span>
      ...
      <!-- <Drawer :closable="true" width="60" v-model="ucNavDrawerModal" class="header_nav_mobile uc_header_nav">
