module.exports = {
    common: {
        ...
        logout: 'लॉग आउट',
        tip: 'बख्शीश',
        logintip: 'कृपया पहले लौग इन करें',
        expect: 'अपेक्षा के लिए तत्पर हैं!',
        delete: 'क्या आप हटाने की पुष्टि कर रहे हैं?',
        nodata: 'कोई आकड़ा उपलब्ध नहीं है',
        set: 'सेट',
        update: 'संशोधित',
        slogan: "दुनिया के शीर्ष 50 डिजिटल मुद्रा एक्सचेंज",
        subslogan: "राज्य एजेंसी संपत्ति सुरक्षा की गारंटी देती है",
        more: "अधिक",
        please: "कृपया",
        nodata: "कोई रिकॉर्ड नहीं",
        pleaseselect: "चुनना",
        searchplaceholder: "सिक्का प्रतीक दर्ज करें ...",
        searchplaceholderswap: "स्वैप चिन्ह दर्ज करें...",
    ...
    header: {
        ...
        ucenter: 'खाता',
        service: 'घोषणा',
        downloadapp: "डाउनलोड और इंस्टॉलेशन के लिए कोड को स्कैन करें",
        appdownlaod: 'ऐप डाउनलोड करें',
        ...
        bzb: "BZB ECO",
        assetmanage: "वित्त",
        trademanage: "अदला-बदली",
        activity: "बिजली चमकना",
        lab: "BITEARN प्रयोगशाला",
        ctc: "C2C अदला-बदली",
        labdetail: "BITEARN लाइटनिंग लैब",
        invite: "पार्टनर को बढ़ावा देना",
        whitepaper: "सफ़ेद कागज",
        scandownload: "ऐप डाउनलोड करें",
        innovationmanage: "नवाचार",
        swap1: "स्वैप (pro)",
        swap2: "स्वैप (ex)",
        swap3: "CFD",
        swap4: "दूसरा",
        cexchange: "क्विकएक्सचेंज",
        option: "विकल्प अनुबंध",
        news: "समाचार"
    },
    sectionPage: {
        ptaqTitle: 'प्लेटफार्म सुरक्षा',
        ptaqContent: "हैश एल्गोरिथ्म का उपयोग दुनिया के अग्रणी सुरक्षा प्रमाणीकरण को एन्क्रिप्ट करने के लिए किया जाता है",
        ptslTitle: 'प्लेटफार्म ताकत',
        ptslContent: "दुनिया का सबसे बड़ा बिटकॉइन ट्रेडिंग प्लेटफॉर्म",
        newsTitle: 'समाचार केंद्र',
        brandTitle: "लगभग BITEARN",
        brandDetail: "ईमानदार  |  गोरा  |  जोश  |  खुला",
        brandDesc1: "BITEARN की स्थापना शुरुआती बिटकॉइन प्रतिभागियों और गीक्स के एक समूह द्वारा की गई थी। टीम के मुख्य सदस्य Google, Microsoft, अलीबाबा, Tencent आदि जैसे प्रसिद्ध उद्यमों से हैं। इसमें गहन अनुसंधान और विकास शक्ति और इंटरनेट उत्पाद संचालन में समृद्ध अनुभव है।",
        brandDesc2: "BITEARN ब्लॉक चेन के मूल सेवा प्रदाता में स्थित है, जो वैश्विक उपयोगकर्ताओं के लिए उच्च गुणवत्ता वाली एन्क्रिप्टेड संपत्ति व्यापार मंच प्रदान करने के लिए समर्पित है, जो ग्राहकों के लिए ईमानदार, निष्पक्ष और उत्साही सेवा को कायम रखते हुए, 'ईविल न बनें 'के मूल सिद्धांत का पालन करता है, और सभी भागीदारों/परियोजनाओं का स्वागत करते हैं जो खुले दृष्टिकोण के साथ उपयोगकर्ताओं के मौलिक हितों के लिए फायदेमंद हैं।",
        gettingstart: "गरम  | शुरुआती मार्गदर्शक",
        officialstart: "BITEARN आधिकारिक ग्राहक सेवा",
        ...
        baseknowtips: "T+0 टू-वे ट्रेडिंग वर्चुअल गुड्स को वस्तु विनिमय अनुबंध के रूप में",
        baseexchange: "विकल्प अनुबंध",
        baseexchangetips: "एक डिजिटल संपत्ति व्युत्पन्न है",
        usersocial: "त्वरित विनिमय",
        usersocialtips: "जल्दी से डिजिटल संपत्तियों का आदान-प्रदान करें",
        mainboard: "मुख्य बोर्ड",
        preview: "पहले का",
        nextpage: "अगला",
        downloadwhite: "श्वेत पत्र डाउनलोड करें"
    },
    nav: {
        ptjy: 'प्लेटफार्म ट्रेडिंग',
        ptaq: 'प्लेटफार्म सुरक्षा',
        ptsl: 'प्लेटफार्म ताकत',
        xwzx: 'समाचार केंद्र',
        fabu: 'विज्ञापन देना',
    },
    progress: {
        already: "खोदना है",
        total: "खुदाई योग्य अयस्क की मात्रा 6 अरब बीएचबी"
    },
    service: {
        USDT: 'USDT',
        BTC: 'BTC',
    ...
    exchange: {
        ...
        cancel_favorite: 'एकत्रित रद्द करें',
        type: "प्रकार",
        dealamount: "समाप्त राशि",
        high: 'ऊँचा',
        low: 'कम',
        vol: '24H Vol',
        buy: 'खरीदना',
        sell: 'बेचना',
        limited_price: 'सीमित कीमत',
        market_price: 'बाजार कीमत',
        fees_rate: 'शुल्क दर',
        balance: 'शेष राशि',
        or: 'या',
        starttrade: 'व्यापार अब!',
        canuse: 'उपलब्ध',
        recharge: 'जमा करना',
        ...
        amount: 'राशि',
        buyin: 'खरीदना',
        disablebuyin: "बाजार खरीदें अक्षम",
        buytip: 'इष्टतम खरीदें',
        sellprice: 'विक्रय मूल्य',
        sellnum: 'बिक्री राशि',
        sellout: 'बेचना',
        disablesellout: "बाजार बेचना अक्षम",
        selltip: 'इष्टतम बिक्री',
        curdelegation: 'प्रतिनिधि',
        hisdelegation: 'इतिहास प्रतिनिधि',
        realtransaction: 'बाजार व्यापार',
        num: 'राशि',
        price: 'कीमत',
        direction: 'दिशा',
        time: 'समय',
        ...
        parted: "जुदा",
        tip: 'बख्शीश',
        buyamounttip: 'खरीद राशि दर्ज करें',
        buyamounttipwarning: 'अधिक नहीं खरीदें राशि',
        success: 'सबमिट करना सफल होना!',
        pricetip: 'खरीद मूल्य दर्ज करें',
        pricetipwarning: 'कीमत अधिक नहीं खरीदें',
        sellamounttip: 'बिक्री राशि दर्ज करें',
        sellamounttipwarning: 'बिक्री राशि अधिक नहीं',
        sellpricetip: 'बिक्री मूल्य दर्ज करें',
        sellpricetipwarning: 'बिक्री मूल्य अधिक नहीं',
        undotip: 'पूर्ववत करने की पुष्टि करें?',
        cancelsuccess: "रद्द आदेश सफल",
        ...
        kline: "KLine",
        depth: "गहराई",
        publishstate0: "इसकी शुरुआत होने वाली है। कृपया प्रतीक्षा कीजिये....",
        publishstate1: "यह खत्म होने वाला है। कृपया प्रतीक्षा कीजिये...",
        publishstate2: "समेकन आदेश, कृपया प्रतीक्षा करें...",
        publishstate3: "समेकन समाप्त हो गया है, कृपया मुक्त व्यापार करें....",
        publishdetail: "अधिक जानकारी",
        publishprice: "कीमत",
        publishamount: "राशि",
        publishcounttxt0: "बाद में शुरू करें",
        publishcounttxt1: "अंत के बाद",
        publishcounttxt2: "मुक्त व्यापार के बाद",
        publishcounttxt3: "गतिविधि खत्म!",
        dateTimeDay: "D",
        dateTimeHour: "H",
        dateTimeMinutes: "M",
        dateTimeSeconds: "S",
    ...
    activity: {
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（WWW.BIZZAN.VIP）",
    ...
    invite: {
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@bizzan.vip, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to bizzan.vip.",
        pt_card_day: "Days",
    ...
    description: {
        ...
        aboutdesc4: "bizzan.vip strictly screens high-quality projects and provides secure and stable asset hosting services. bizzan.vip upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
