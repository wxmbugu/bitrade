module.exports = {
    ...
    header: {
        ...
        lab: "BITEARN Lab",
        ctc: "C2C Exchange",
        labdetail: "BITEARN Lightning Lab",
    ...
    sectionPage: {
        ...
        brandTitle: "About BITEARN",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "BITEARN was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent and so on. It has deep research and development strength and rich experience in Internet product operation.",
        brandDesc2: "BITEARN is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "BITEARN Official Customer Service",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by BITEARN, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of BITEARN.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（WWW.BTEARN.com）",
    ...
    invite: {
        ...
        copyed: "Copied",
        mylevel1: "L1 friends",
        mylevel1ratio: "L1 friends return ratio",
        mylevel2ratio: "L2 friends return ratio",
        mylevel3ratio: "L3 friends return ratio",
        mylevel4ratio: "L4 friends return ratio",
        mylevel5ratio: "L5 friends return ratio",
        mylevel6ratio: "L6 friends return ratio",
        mylevel7ratio: "L7 friends return ratio",
        mylevel8ratio: "L8 friends return ratio",

        mycommission: "Commission income(USDT)",
        extrareward: "Additional rewards",
        partnerlevel: "Partnership level",
        ruledetail: "Rule details",
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with BITEARN trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1、In order to preach the concept of digital assets and expand the scale of users, BITEARN launched the “Promotion Partner” program, which is effective for a long time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to BITEARN.",
        ...
        thanks: "Thank you for supporting BITEARN！",
        ...
        pt_tips: "If you have a good idea, please send an email to realbitearn@gmail.com, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to btearn.com.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        regist: {
            ...
            telregist: 'Tel Register',
            emailregist: 'Email Register',
        ...
        identity: {
            ...
            become: "Become BITEARN Certified Business and enjoy more transaction privileges",
        ...
        api: {
            ...
            hint: 'How to Connect your bybit account',
            part1: "Bybit provides you with a powerful API use",
            apiDoc: "this link,",
            howUse: "to get your api key and secret.",
            // part2: "Each user creates up to five sets of API keys",
            part2: "While creating the API key, do not enable withdrawals",
            part3: "Copy and paste your API key and secret to the form on the left then click the create button to add your keys to the platform.",
            myApiKey: "My API Key",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "BITEARN APP - Trade everywhere."
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        aboutdesc1: "btearn.com is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of btearn.com come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
        aboutdesc2: "btearn.com platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities, btearn.com adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: "btearn.com strictly screens high-quality projects and provides secure and stable asset hosting services. btearn.com upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
    ...
    index: {
        ...
        BHBregister: "BITEARN account registration",
        ...
        fenpeijizhi: 'A description of the BITEARN income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, BITEARN will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
   ...
   faq: {
        question1: "How can I invest through Btearn.com?",
        answer1: 'You can register on our site and then buy and sell digital currencies.',
        question2:"How do I start crypto?",
        answer2:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
        question3: "Lorem ipsum dolor sit amet, consectetur adipiscing elit?",
        answer3: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
