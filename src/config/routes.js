...
//    { path: '/', component: resolve=>(require(["../pages/index/Index.vue"],resolve)) },
    ...
    { path: '/login/returnUrl/:returnUrl', component: resolve=>(require(["../pages/uc/Login.vue"],resolve)) },
    { path: '/register', component: resolve=>(require(["../pages/uc/Register.vue"],resolve)) },
    ...
    { path: '/findPwd', component: resolve=>(require(["../pages/uc/FindPwd.vue"],resolve)) },
    { path: '/exchange', component: resolve=>(require(["../pages/exchange/Exchange.vue"],resolve)) },
    { path: '/exchange/:pair', component: resolve=>(require(["../pages/exchange/Exchange.vue"],resolve)), name: "ExchangePair"},
    ...
    { path: '/help', component: resolve=>(require(["../pages/cms/Help.vue"],resolve)) },
