<template>
  <div :class="pageView">
          ...
          <div class="layout-ceiling-main">
            ...
            <div class="header_nav">
              <Menu :active-name="activeNav" width="auto"  :open-names="['1']">
                <Submenu name="1">
                  <!-- <router-link to="/">
                    <MenuItem :style="menuFontSize" name="nav-index">{{$t("header.index")}}</MenuItem>
                  </router-link> -->
                 
                  <!-- <router-link to="/exchange">
                    <MenuItem :style="menuFontSize" name="nav-exchange">{{$t("header.exchange")}}</MenuItem>
                  </router-link> -->
                   <router-link to="/swap">
                    <MenuItem :style="menuFontSize" name="nav-swap">{{$t("header.swap1")}}</MenuItem>
                  </router-link> 
                  <!-- <router-link to="/option">
                    <MenuItem :style="menuFontSize" name="nav-option">{{$t("header.option")}}</MenuItem>
                  </router-link> -->
                  <!-- <router-link to="/lab" style="position:relative;">
                    <MenuItem :style="menuFontSize" name="nav-lab">{{$t("header.lab")}}</MenuItem>
                  </router-link>
		               -->
                  ...
                  <router-link to="/whitepaper" style="display: none;">
                    <MenuItem name="nav-whitepaper">{{$t("header.whitepaper")}}</MenuItem>
                  
                  </router-link> -->
            
             <div class="header_nav more-item" style="float:right;margin-left: 10px;">
              <Menu mode="horizontal" width="auto"  style="height: 50px;line-height:50px;">
                  <Submenu name="h01">
                      <!-- <template slot="title" class="lang-title">
                        <span :style="menuFontSize" >{{$t("common.more")}}</span>
                      </template> -->
                       <!-- <router-link to="/ctc" >
                         <MenuItem  :style="menuFontSize" name="nav-ctc">{{$t("header.ctc")}}</MenuItem>
                        </router-link> -->
				               <!-- <router-link to="/otc/trade/usdt"  >
				                  <MenuItem :style="menuFontSize" name="nav-otc">{{$t("header.otc")}}</MenuItem>
				              </router-link> -->
                      <!-- <router-link to="/cexchange">
                       <MenuItem :style="menuFontSize" name="nav-cexchange">{{$t("header.cexchange")}}</MenuItem>
                      </router-link> -->
                       <!-- <router-link to="/invite">
                         <MenuItem :style="menuFontSize" name="nav-invite">{{$t("header.invite")}}</MenuItem>
                       </router-link> -->
                       <!-- <router-link to="/news" >
                         <MenuItem :style="menuFontSize" name="nav-news">{{$t("header.news")}}</MenuItem>
                       </router-link> -->
                       <!-- <router-link to="/announcement/0">
                         <MenuItem :style="menuFontSize" name="nav-service">{{$t("header.service")}}</MenuItem>
                       </router-link> -->
                       <!-- <router-link to="/whitepaper" >
                         <MenuItem :style="menuFontSize" name="nav-whitepaper">{{$t("header.whitepaper")}}</MenuItem>
                       </router-link> -->
            ...
            <div class="header_nav" style="float:right;margin-left: 10px;">
              <Menu mode="horizontal" width="auto" @on-select="changelanguage" style="height: 50px;line-height:50px;">
                  <Submenu name="lang">
                      <template slot="title" class="lang-title">
                        <span :style="menuFontSize">{{languageValue}}</span>
                        <img class="lang-img" v-if="lang=='en_US'" src="../src/assets/images/flag/lang-en.png" />
						            <img class="lang-img" v-if="lang=='ja_JP'" src="../src/assets/images/flag/lang-jp.png" />
						            <img class="lang-img" v-if="lang=='ko_KR'" src="../src/assets/images/flag/lang-kr.png" />
						            <img class="lang-img" v-if="lang=='de_DE'" src="../src/assets/images/flag/lang-ge.png" />
						            <img class="lang-img" v-if="lang=='fr_FR'" src="../src/assets/images/flag/lang-fr.png" />
						            <img class="lang-img" v-if="lang=='it_IT'" src="../src/assets/images/flag/lang-it.png" />
						            <img class="lang-img" v-if="lang=='es_ES'" src="../src/assets/images/flag/lang-sp.png" />
						            <img class="lang-img" v-if="lang=='zh_HK'" src="../src/assets/images/flag/lang-hk.png" />
						            <img class="lang-img" v-if="lang=='zh_CN'" src="../src/assets/images/flag/lang-zh.png" />
                        <img class="lang-img" v-if="lang=='hi_HI'" src="../src/assets/images/flag/lang-hi.png" />
                        <img class="lang-img" v-if="lang=='ma_MA'" src="../src/assets/images/flag/lang-ma.png" />
                        <img class="lang-img" v-if="lang=='ur_UR'" src="../src/assets/images/flag/lang-ur.png" />
                        <img class="lang-img" v-if="lang=='ta_TA'" src="../src/assets/images/flag/lang-ta.png" />
                        <img class="lang-img" v-if="lang=='in_IN'" src="../src/assets/images/flag/lang-in.png" />
                        <img class="lang-img" v-if="lang=='vi_VI'" src="../src/assets/images/flag/lang-vi.png" />
                      </template>
                      <MenuItem name="en_US" class="lang-item">
                         <div class="flex">
                           <img src="../src/assets/images/flag/lang-en.png" /><p> English</p>
                         </div>
                      </MenuItem>
					  <MenuItem name="ja_JP" class="lang-item">
                <div class="flex">
                           <img src="../src/assets/images/flag/lang-jp.png" /><p> 日本語</p>
               </div>
            </MenuItem>
					  <MenuItem name="ko_KR" class="lang-item">
               <div class="flex">
                           <img src="../src/assets/images/flag/lang-kr.png" /><p> 한국어</p>
               </div>
            </MenuItem>
					  <MenuItem name="de_DE" class="lang-item">
              <div class="flex">
               <img src="../src/assets/images/flag/lang-ge.png" /><p>Deutsche</p>
              </div>
            </MenuItem>
					  <MenuItem name="fr_FR" class="lang-item">
              <div class="flex">
               <img src="../src/assets/images/flag/lang-fr.png" /><p>Français</p>
              </div>
            </MenuItem>
					  <MenuItem name="it_IT" class="lang-item">
               <div class="flex">
                 <img src="../src/assets/images/flag/lang-it.png" /><p> Italiano</p>
               </div>
            </MenuItem>
					  <MenuItem name="es_ES" class="lang-item">
                <div class="flex">
                 <img src="../src/assets/images/flag/lang-sp.png" /><p> Español</p>
               </div>
            </MenuItem>
					  <MenuItem name="zh_HK" class="lang-item">
               <div class="flex">
                 <img src="../src/assets/images/flag/lang-hk.png" /><p> 繁體中文</p>
               </div>
            </MenuItem>
					  <MenuItem name="zh_CN" class="lang-item">
             <div class="flex">
               <img src="../src/assets/images/flag/lang-zh.png" /><p> 简体中文</p>
             </div>
           </MenuItem>
            <MenuItem name="hi_HI" class="lang-item">
               <div class="flex">
                 <img src="../src/assets/images/flag/lang-hi.png" /><p>हिन्दी或हिंदी</p>
               </div>
           </MenuItem>
            <MenuItem name="ma_MA" class="lang-item">
                <div class="flex">
                 <img src="../src/assets/images/flag/lang-ma.png" /><p> Bahasa Melayu</p>
               </div>
            </MenuItem>
             <MenuItem name="ur_UR" class="lang-item">
                <div class="flex">
                 <img src="../src/assets/images/flag/lang-ur.png" /><p> اُردُو</p>
               </div>
            </MenuItem>
            <MenuItem name="ta_TA" class="lang-item">
                <div class="flex">
                 <img src="../src/assets/images/flag/lang-ta.png" /><p>தமிழ்</p>
               </div>
            </MenuItem>

             <MenuItem name="in_IN" class="lang-item">
                <div class="flex">
                 <img src="../src/assets/images/flag/lang-in.png" /><p>Indonesian</p>
               </div>
            </MenuItem>
            <MenuItem name="vi_VI" class="lang-item">
                <div class="flex">
                 <img src="../src/assets/images/flag/lang-vi.png" /><p>Việt ngữ</p>
               </div>
            </MenuItem>
            ...
            <!-- <div class="rightwrapper">
              <poptip placement="bottom" width="120" class="appdownload" trigger="hover">
                <a href="#" :style="menuFontSize">{{$t("header.appdownlaod")}}
                ...
                <div class="api" slot="content">
                  <div class="ios">
                    ...
                    <div class="tips">
                      <span :style="menuFontSize">{{$t("header.scandownload")}}</span>
                    </div>
                  </div>
                </div>
              </poptip>
            ...
            <div class="rr login-container">
              ...
              <div class="login_register isLogin" v-if="isLogin">
                <div class="mymsg">
                  <!-- <router-link to="/uc/safe" :style="menuFontSize">{{$t("header.usercenter")}}</router-link> -->
                  <router-link to="/uc/apiManage" :style="menuFontSize">API Keys</router-link>
                </div>
                <Dropdown>
                  <a href="javascript:void(0)" :style="menuFontSize">
                   ...
                   <DropdownMenu slot="list">
                      <DropdownItem>
                        <router-link to="/uc/swapAssets" :style="menuFontSize">
                           <!-- <Icon type="logo-bitcoin" /> &nbsp;{{$t("header.assetmanage")}} -->
                          <Icon type="logo-bitcoin" /> &nbsp;Assets
                        </router-link>
                      </DropdownItem>
                      <!-- <DropdownItem>
                        <router-link to="/uc/entrust/current" :style="menuFontSize">
                          <Icon type="md-swap" /> &nbsp;{{$t("header.trademanage")}}
                        </router-link>
                      </DropdownItem> -->
                      <!-- <DropdownItem>
                        <router-link to="/uc/innovation/myorders" :style="menuFontSize">
                          <Icon type="md-swap" /> &nbsp;{{$t("header.innovationmanage")}}
                        </router-link>
                      </DropdownItem> -->
                      <DropdownItem>
                        <div @click="logout" :style="menuFontSize">
    ...
    <Drawer :closable="true" width="60" v-model="navDrawerModal" class="header_nav_mobile">
        <Menu :active-name="activeNav" width="auto"  >
            <!-- <router-link to="/">
            ...
            <router-link to="/swap">
              <MenuItem name="nav-swap" style="text-align:left;">{{$t("header.swap1")}}</MenuItem>
            </router-link>
            <!-- <router-link to="/option">
               <MenuItem name="nav-option" style="text-align:left;">{{$t("header.option")}}</MenuItem>
             </router-link> -->
            <!-- <router-link to="/invite">
            ...
            <!-- <router-link to="/app">
              ...
              <MenuItem name="nav-aboutus" style="text-align:left;color:#bdc2ca;">{{$t("cms.aboutus")}}</MenuItem>
            </router-link> -->

        </Menu>
        <Menu  @on-select="changelanguage">
      <div style="height: 1px;width:100%;background:rgb(59, 69, 85);margin-top:10px;margin-bottom:10px;"></div>
        ...
        <MenuItem name="hi_HI" class="lang-item" style="padding-left:20px!important;"></img>हिन्दी或हिंदी</MenuItem>
        <MenuItem name="ma_MA" class="lang-item" style="padding-left:20px!important;"></img>Bahasa Melayu</MenuItem>
        <MenuItem name="ur_UR" class="lang-item" style="padding-left:20px!important;"></img>اُردُو</MenuItem>
        <MenuItem name="ta_TA" class="lang-item" style="padding-left:20px!important;"></img>தமிழ்</MenuItem>
         <MenuItem name="in_IN" class="lang-item" style="padding-left:20px!important;"></img>Indonesian</MenuItem>
          <MenuItem name="vi_VI" class="lang-item" style="padding-left:20px!important;"></img>Việt ngữ</MenuItem>
            </Submenu>
        </Menu>
    </Drawer>
    <div class="footer">
      <div class="footer_content">
        <div class="footer_left">
          <img  src="./assets/images/logo-footer.png" style="margin:0" ></img>
          <!-- <h3>Caymanex.Pro</h3> -->
          ...
          <div class="social-list">
            <ul>
              ...
              <Tooltip content="Telegram" theme="dark" placement="top">
                ...
                <div slot="content">
                    <img style="width: 130px;border-radius: 5px;" src="./assets/images/telegramqrcode.jpeg">
                </div>
              </Tooltip>
              <Tooltip content="" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconweibo" />
                </li>
              </Tooltip>
              <Tooltip content="https://twitter.com/crypttops" theme="dark" placement="top">
                <li>
      ...
      <!--  <div class="footer_right" style="margin-left: 5%;border-left: 1px solid #243051;padding-left: 5%;">
        ...
        <div class="footer_right">
          <ul>
            ...
            <li>
              <router-link target="_blank" to="/">{{$t("footer.gywm")}}</router-link>
            </li>
            <li>
              <router-link target="_blank" to="/">{{$t("footer.jrwm")}}</router-link>
            </li>
            <li>
              <router-link target="_blank" to="/">{{$t("footer.notice")}}</router-link>
            </li>
          ...
          <ul>
            ...
            <li>
              <router-link target="_blank" to="/" >{{$t("footer.xszn")}}</router-link>
            </li>
            <li>
              <router-link target="_blank" to="/" >{{$t("footer.cjwt")}}</router-link>
            </li>
            <li>
              <router-link target="_blank" to="/" >{{$t("footer.jyzn")}}</router-link>
            </li>
            <li>
              <router-link target="_blank" to="/" >{{$t("footer.bzzl")}}</router-link>
            </li>
          </ul>
          <ul>
            <li class="footer_title">
            ...
            <li>
              <router-link target="_blank" to="/" >{{$t("footer.mztk")}}</router-link>
            </li>
            <li>
              <router-link target="_blank" to="/" >{{$t("footer.ystk")}}</router-link>
            </li>
            <li>
              <router-link target="_blank" to="/" >{{$t("footer.fwtk")}}</router-link>
            </li>
            <li>
              <router-link target="_blank" to="/">{{$t("footer.fltk")}}</router-link>
            </li>
          </ul>
          <!-- <ul>
            <li class="footer_title">
            ...
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">realbitearn@gmail.com</p>
                </div>
              </poptip>
            </li>
            ...
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                <a href="javascript:;" class="wechat">{{$t("footer.jrwm")}}</a>
                <div slot="content">
                  <p style="text-align:center;">www.btearn.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">list@bizzan.vip</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">ceo@bizzan.vip</p>
                </div>
              </poptip>
            </li>
          </ul> -->
...
export default {
  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "zh_CN" ? "交易中心" : "Exchange") + " - Disdev | Disdev | Bybit Trading Bot";
          break;
        case "nav-service":
          window.document.title = (this.lang == "zh_CN" ? "公告" : "Announcement") + " - Disdev | Disdev | Bybit Trading Bot";
          break;
        case "nav-about":
          window.document.title = (this.lang == "zh_CN" ? "关于" : "About") + " - Disdev | Disdev | Bybit Trading Bot";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "zh_CN" ? "创新实验室" : "Lab") + " - Disdev | Disdev | Bybit Trading Bot";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "zh_CN" ? "推广合伙人" : "Promotion") + " - Disdev | Disdev | Bybit Trading Bot";
          break;
	case "nav-cexchange":
          window.document.title = (this.lang == "zh_CN" ? "活动" : "Activity") + " - Disdev | Bybit Trading Bot";
          break;
        default:
          window.document.title = "Disdev | Bybit Trading Bot";
          break;
      }
    },
    $route(to, from) {
  ...
  computed: {
    ...
    if(curlang=="ta_TA"){
     ...
     if(screen.width<=1120){
       fontSize="font-size:3px;";
     }
	  }
     if(curlang=="vi_VI"){
	  	fontSize="font-size:14px;";
       if(screen.width<=1505){
       fontSize="font-size:11px;";
     }
  ...
  methods: {
    ...
    customerService(){
    this.langType=JSON.parse(localStorage.getItem('LANGUAGE'));
     console.log("mounted lang:",this.langType);
    // if(this.langType=="zh_CN")
    // {
      
    //   GOFLY.init({
    //      GOFLY_URL:"https://customer.btearn.com",
    //      GOFLY_KEFU_ID: "kefu_cn",
...
　　let flag = navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i)
    ...
    //  this.langType=name;
	  ...
	  if(name!="en_US" && name!="ja_JP" && name!="ko_KR" && name!="de_DE" && name!="fr_FR" && name!="it_IT" && name!="es_ES" && name!="zh_HK" && name!="zh_CN" && name!="hi_HI" && name!="ma_MA" && name!="ur_UR" && name!="ta_TA"
    && name!="vi_VI" && name!="in_IN"){
...
@media only screen and (max-width:1550px) {
  ...
  //   }
  // }
  // .page-view .page-content .layout .layout-ceiling .rr .mymsg a{
  //   font-size: 11px !important;
  // }
  // .page-view .page-content .layout .layout-ceiling .rr .isLogin .ivu-dropdown .ivu-dropdown-rel a{
  //   font-size: 11px !important;
  // }
}
              ...
              .ivu-menu {
                a {
                  ...
                  li.ivu-menu-item.ivu-menu-item-active.ivu-menu-item-selected {
                    color: #ffec03;
                        border-bottom: 3px solid #ffec03;
                  }
                }
...
.ivu-menu-vertical .ivu-menu-submenu-active{
  color: #ffec03 !important;
}
