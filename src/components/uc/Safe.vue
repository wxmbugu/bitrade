                    ...
                    <div class="account-in">
                        ...
                        <div class="account-item">
                            <div class="account-item-in">
                                ...
                                <p v-else-if="user.realVerified==0&&user.realAuditing==0&&user.realNameRejectReason!=null" class="bankInfo" style="color: #ffec03;font-size: 13px;">
                                    {{$t('common.Reviewfailed')}}{{user.realNameRejectReason?"："+user.realNameRejectReason:""}}，{{$t('common.tryagain')}}
                                </p>
                            ...
                            <div class="account-detail" v-show="choseItem==6">
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate6" :model="formValidate6" :rules="ruleValidate" :label-width="100"  label-position="left"  style="text-align:left;">
                                        <!-- 真实姓名 -->
                        ...
                        <div class="account-item" >
                            ...
                            <div class="account-detail" v-show="choseItem==2">
                                <div class="detail-list" style="width:100%">
                                        <!-- 真实姓名 -->
                                    <Form ref="formValidate2" :model="formValidate2"  :rules="ruleValidate" :label-width="150"  label-position="left"  style="text-align:left;" >
                                        <!-- mail -->
                        ...
                        <div class="account-item">
                            ...
                            <div class="account-detail" v-show="choseItem==3">
                                <div class="detail-list" style="width:100%;">
                                    <Form ref="formValidate3" :model="formValidate3" label-position="left" :rules="ruleValidate"  :label-width="170"  style="text-align:left;"    >
                                        <!-- 手机 -->
                        ...
                        <div class="account-item">
                            ...
                            <div class="account-detail" v-show="choseItem==4">
                                <div class="detail-list">
                                    <Form ref="formValidate4" :model="formValidate4" :rules="ruleValidate" :label-width="170"  label-position="left"  style="text-align:left;">
                                        <!-- oldPw -->
                        ...
                        <div class="account-item">
                            ...
                            <div class="account-detail" v-show="choseItem==5" >
                                ...
                                <div class="detail-list" v-show="user.fundsVerified!=1">
                                    <Form ref="formValidate7" :model="formValidate7" :rules="ruleValidate" :label-width="140"  label-position="left"  style="text-align:left;">
                                        <!-- newMPw -->
