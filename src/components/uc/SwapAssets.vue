      ...
      <div class="bill_box rightarea padding-right-clear">
        <div class="shaow">
          <div class="money_table">
            ...
            <!-- <Button type="primary" @click="onTransferClick" class="top-btn">{{$t('uc.finance.swap.transfor')}}</Button> -->
            </div>
            <div style="overflow-x:scroll;">
           
          
           <Table class="page-tbl" :no-data-text="$t('common.nodata')" :columns="tableColumnsMoney" :data="tableMoneyShow" :loading="loading" :disabled-hover="true"></Table>
           </div> 
          </div>
        </div>
      </div>
...
.top-btn{
  padding: 6px 15px;margin-right:30px;letter-spacing:2px;color:#ffec03;background-color:transparent;border:1px solid #ffec03;float:right;
}
.nav-right {
  .rightarea.bill_box {
    .shaow {
...
.trans-all-btn{
  display:inline-block;margin-left: 20px;font-weight: bold;color:#ffec03;background-color:transparent;
  &:hover{
    cursor: pointer;
  }
}
