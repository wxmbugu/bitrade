          ...
          <div class="form-group">
            ...
            <Select v-model="recordValue" clearable style="width:200px" @on-change="getType" :placeholder="$t('common.pleaseselect')">
              <Option v-for="item in recordType" :value="item.value" :key="item.value">{{ item.label }}</Option>
                      ...
                      <Button type="warning" @click="queryOrder" style="padding: 6px 30px;margin-left:10px;margin-bottom:20px;background-color:#ffec03;border-color:#ffec03;color:#5c5b59;">{{$t('uc.finance.record.search')}}</Button>

          <div class="order-table">
            <Table class="order-tbl" :no-data-text="$t('common.nodata')" :columns="tableColumnsRecord" :data="tableRecord" :disabled-hover="true" :loading="loading"></Table>
