          ...
          <div class="table-inner">
            <div class="action-inner">
              ...
              <div class="mt25">
                <p class="describe">&nbsp;</p>
                <div class="title">
                  <Button id="withdrawCodeSubmit" @click='generate' size="large" style="color:#fff;background:#ffec03;border:1px solid #ffec03;margin-top:10px;">{{$t('uc.finance.withdraw.generateCode')}}</Button>
                </div>
              </div>
            </div>
