        ...
        <div class="shaow">
          <div class="money_table">
            <div class="money-header">
              ...
              <Button @click="toQuickExchange" type="warning" class="quick-btnn">{{$t('uc.finance.record.quickExchange')}}</Button>
            </div>
            <div class="money-tbl">
...
.quick-btnn{
 padding: 6px 30px;margin-right:30px;background-color:#ffec03;border-color:#ffec03;float:right;
