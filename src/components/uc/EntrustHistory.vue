  ...
  <div class="entrusthistory">
    <Form class="form" :model="formItem" :label-width="75" inline>
      <FormItem :label="$t('uc.finance.trade.start_end')">
        <DatePicker type="daterange" v-model="formItem.date" class="select-width"></DatePicker>
      </FormItem>
      <FormItem :label="$t('uc.finance.trade.symbol')">
        <Select v-model="formItem.symbol" class="select-width" :placeholder="$t('common.pleaseselect')">
          <Option v-for="(item,index) in symbol" :key="index" :value="item.symbol">{{item.symbol}}</Option>
        </Select>
      </FormItem>
      <FormItem :label="$t('uc.finance.trade.type')">
        <Select v-model="formItem.type" class="select-width" :placeholder="$t('common.pleaseselect')">
      ...
      <FormItem :label="$t('uc.finance.trade.direction')">
        <Select v-model="formItem.direction" class="select-width" :placeholder="$t('common.pleaseselect')">
    ...
    <div class="table">
      <Table class="current-tbl" :no-data-text="$t('common.nodata')" :columns="columns" :data="orders" :loading="loading"></Table>
      <div class="page">
