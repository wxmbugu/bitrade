      ...
      <div class="bill_box rightarea padding-right-clear">
        <div class="shaow">
          <div class="money_table">
            <div style="width: 100%;height: 50px;" class="mobile-btn">
              <div class="header-btn" @click="exchangeCard">{{$t('uc.promotion.exchangewithcode')}}</div>
            </div>
            <div style="overflow-x:scroll;">
             <Table class="money_tbl" :no-data-text="$t('common.nodata')" :columns="tableColumnsCard" :data="tableCardList" :loading="loading" :disabled-hover="true"></Table>
...
@media only screen and (max-width:768px) 
{
 ...
 .header-btn{
  ...
  border: 1px solid #ffec03 !important;
...
.header-btn{
  float:right;padding: 5px 15px;border: 1px solid #ffec03;color: #ffec03;
  margin-left: 20px;
  &:hover{
    background: #ffec03;
    color: #000;
